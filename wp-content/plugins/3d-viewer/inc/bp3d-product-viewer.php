...
function bp3d_product_model_viewer() {
    ...
    $camera_controls = $settings_opt['bp_camera_control'] === '1' ? 'camera-controls' : '';
    $auto_rotate    = $settings_opt['bp_3d_rotate'] === '1' ? 'auto-rotate' : '';
    $zooming_3d     = $settings_opt['bp_3d_zooming'] === '1' ? '' : 'disable-zoom';

    // Preload
    $loading   = isset($settings_opt['bp_3d_loading']) ? $settings_opt['bpp_3d_loading'] : '';

    // AutoPlay and Shadow Intensity
    $model_autoplay = isset($settings_opt['bp_3d_autoplay']) && $settings_opt['bp_3d_autoplay'] === '1'? 'autoplay': '';
